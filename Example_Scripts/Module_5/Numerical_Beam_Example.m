...
%% Physical Substructuring via M,K matrices of A & B 
...
% Primal Assembly of Physical Subsystems
M_PHS = L_PHS.'*blkdiag(M_A,M_B)*L_PHS;
C_PHS = L_PHS.'*blkdiag(C_A,C_B)*L_PHS;
K_PHS = L_PHS.'*blkdiag(K_A,K_B)*L_PHS;
...
%% Frequency Based Substructuring using Subsystem FRFs
